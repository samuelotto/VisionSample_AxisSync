...
#ifndef POWERLNK_H_
#define POWERLNK_H_ 0x1109 /* Version V1.10.9 */
#ifdef __cplusplus
extern "C" 
{
#endif
...
#define ERR_PLMGR_ALREADY_INITIALIZED       20937   /* station already initialized */
#define ERR_PLMGR_INIT_NOT_FINISHED         20938   /* initialization of delayed station not finished yet*/
...
#define ERR_PLMGR_PARSE_ARRAYSIZE           20965   /* arraysize not valid */
...
/* action 26, 27 cycletime info for NCManager */
#define plACTION_SET_STATION_NUMBER       28  /* set node number of delayed iCN */
/* action 29 used by vision */
...
#define plSYSCONF_STATIONFLAG_SLOW              0x20  /* Station is a slow one */
 ...
 #endif
 _GLOBAL_CONST signed char plCE_CYCLIC_8;
 _GLOBAL_CONST signed char plCE_CYCLIC_7;
 _GLOBAL_CONST signed char plCE_CYCLIC_6;
 _GLOBAL_CONST signed char plCE_CYCLIC_5;
 _GLOBAL_CONST signed char plCE_CYCLIC_4;
 _GLOBAL_CONST signed char plCE_CYCLIC_3;
 _GLOBAL_CONST signed char plCE_CYCLIC_2;
 _GLOBAL_CONST signed char plCE_CYCLIC_1;
 _GLOBAL_CONST signed char plCE_TIMER_2;
 _GLOBAL_CONST signed char plCE_TIMER_1;
 _GLOBAL_CONST unsigned long plOPEN_MODE_LENGTH;
 _GLOBAL_CONST unsigned long plOPEN_MODE_EPLV2;
 _GLOBAL_CONST unsigned long plOPEN_MODE_EPLV1;
 _GLOBAL_CONST unsigned long plOPEN_MODE_RW;
 _GLOBAL_CONST unsigned long plOPEN_MODE_WRITE;
 _GLOBAL_CONST unsigned long plOPEN_MODE_READ;
 _GLOBAL_CONST unsigned char plSYSCONF_STATIONFLAG_SLOW;
 _GLOBAL_CONST unsigned short plSTATE_WRONG_IDENT;
 _GLOBAL_CONST unsigned short plSTATE_CE_ERROR;
 _GLOBAL_CONST unsigned short plSTATE_CE_INACTIVE;
 _GLOBAL_CONST unsigned short plSTATE_CE_ACTIVE;
 _GLOBAL_CONST unsigned short plSTATE_CE_WAITING;
 _GLOBAL_CONST unsigned short plSTATE_STATION_FAILED;
 _GLOBAL_CONST unsigned short plSTATE_STATION_CFGFAILED;
 _GLOBAL_CONST unsigned short plSTATE_STATION_CHANGED;
 _GLOBAL_CONST unsigned short plSTATE_STATION_INACTIVE;
 _GLOBAL_CONST unsigned short plSTATE_STATION_ACTIVE;
 _GLOBAL_CONST unsigned short plSTATE_STATION_ACTIVATEING;
 _GLOBAL_CONST unsigned short plSTATE_STATION_CONFIG;
 _GLOBAL_CONST unsigned short plSTATE_STATION_OSDL;
 _GLOBAL_CONST unsigned short plSTATE_STATION_WAITING;
 _GLOBAL_CONST unsigned short plSTATE_STATION_NONEXISTANT;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_WRITE_WRONG;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_WRITE_OPEN;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_WRITE_ACTIVE;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_WRITE_CLOSED;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_WRITE_MASK;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_READ_WRONG;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_READ_READY;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_READ_EMPTY;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_READ_CLOSED;
 _GLOBAL_CONST unsigned short plSTATE_CHANNEL_READ_MASK;
 _GLOBAL_CONST unsigned char plMESSAGE_TYPE_PRES;
 _GLOBAL_CONST unsigned char plMESSAGE_TYPE_PREQ;
 _GLOBAL_CONST unsigned char plDIRECTION_XOUT;
 _GLOBAL_CONST unsigned char plDIRECTION_OUT;
 _GLOBAL_CONST unsigned char plDIRECTION_IN;
 _GLOBAL_CONST unsigned long plACTION_GET_PDO_INFO;
 _GLOBAL_CONST unsigned long plACTION_GET_DP_INFO;
 _GLOBAL_CONST unsigned long plACTION_GET_CROSSLINK_INFO;
 _GLOBAL_CONST unsigned long plACTION_GET_IF_RSQUEUELAPCNT;
 _GLOBAL_CONST unsigned long plACTION_GET_IF_MUXPRESCALE;
 _GLOBAL_CONST unsigned long plACTION_GET_IF_PRESCALE;
 _GLOBAL_CONST unsigned long plACTION_GET_IF_CYCLE_TIME;
 _GLOBAL_CONST unsigned long plACTION_GET_STATION_HWVARIANT;
 _GLOBAL_CONST unsigned long plACTION_GET_STATIONFLAG;
 _GLOBAL_CONST unsigned long plACTION_GET_IF_PARAMETERS;
 _GLOBAL_CONST unsigned long plACTION_GET_STATION_NUMBER;
 _GLOBAL_CONST unsigned long plACTION_DEVICE_TO_BUS_NR;
 _GLOBAL_CONST unsigned long plACTION_GET_FIRMWARE_VERSION;
 _GLOBAL_CONST unsigned long plACTION_GET_SYNC_STATISTICS;
 _GLOBAL_CONST unsigned long plACTION_STOP_SYNC_STATISTICS;
 _GLOBAL_CONST unsigned long plACTION_START_SYNC_STATISTICS;
 _GLOBAL_CONST unsigned long plACTION_GET_IDENT;
 _GLOBAL_CONST unsigned long plACTION_GET_NET_QUALITY;
 _GLOBAL_CONST unsigned long plACTION_SET_STATION_NUMBER;
 _GLOBAL_CONST unsigned short ERR_PLMGR_NO_POWERLNK_LIBRARY;
 _GLOBAL_CONST unsigned short ERR_PLMGR_EXCEPTION;
 _GLOBAL_CONST unsigned short ERR_PLMGR_INTERNAL;
 _GLOBAL_CONST unsigned short ERR_PLMGR_RECOMMEND_FW_UPDATE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_HW_BOOTUP_FAILED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_WARNING_FW_UPDATE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_ARRAYSIZE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_TRAILINGCHARS;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_SUBSLOT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_SLOT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_NETTIME;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_TO_MANY_NUMBERS;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_BIT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_CHANNEL;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_SUBMODUL;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_MODUL;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_STATION;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_INTERFACE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_NOT_IN_OR_OUT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_NO_PERCENT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_END_EXPECTED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_PARSE_ERROR;
 _GLOBAL_CONST unsigned short ERR_PLMGR_INIT_NOT_FINISHED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_ALREADY_INITIALIZED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_NO_PDO_MAPPING_DEFINED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_UNKNOWN_TYPE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_NOT_IN_PRES;
 _GLOBAL_CONST unsigned short ERR_PLMGR_CONFIG_CONFLICT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_SYNC_FAILED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_SYNC_BY_SYSTEM;
 _GLOBAL_CONST unsigned short ERR_PLMGR_BUS_CONFIGURED_TWICE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_TOO_MANY_INTERFACES;
 _GLOBAL_CONST unsigned short ERR_PLMGR_STATION_NOT_ACTIVE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_WRONG_TASKCLASS;
 _GLOBAL_CONST unsigned short ERR_PLMGR_UNAVAILABLE_DATAPOINT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_OVERFLOW;
 _GLOBAL_CONST unsigned short ERR_PLMGR_NIL_POINTER;
 _GLOBAL_CONST unsigned short ERR_PLMGR_OFFSET_TO_HIGH;
 _GLOBAL_CONST unsigned short ERR_PLMGR_WRITE_ACTIVE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_FRAME_TOO_LONG;
 _GLOBAL_CONST unsigned short ERR_PLMGR_NO_FRAME_RECEIVED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_CHANNEL_ALREADY_OPEN;
 _GLOBAL_CONST unsigned short ERR_PLMGR_ERROR_ALLOC_BUFFER;
 _GLOBAL_CONST unsigned short ERR_PLMGR_ERROR_ALLOC_CHANNEL;
 _GLOBAL_CONST unsigned short ERR_PLMGR_ERROR_ALLOC_STATION;
 _GLOBAL_CONST unsigned short ERR_PLMGR_WRONG_IDENT;
 _GLOBAL_CONST unsigned short ERR_PLMGR_ILLEGAL_PARAMETER;
 _GLOBAL_CONST unsigned short ERR_PLMGR_NOT_IMPLEMENTED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_ALREADY_CONFIGURATED;
 _GLOBAL_CONST unsigned short ERR_PLMGR_CONFIG_NOT_FOUND;
 _GLOBAL_CONST unsigned short ERR_PLMGR_WRONG_DEVICE;
 _GLOBAL_CONST unsigned short ERR_PLMGR_NOMEM;
 _GLOBAL_CONST unsigned short ERR_PLMGR_VERS_CONFLICT;
#endif
...
typedef struct PLSYSCONF_IF_typ/* Configuration structure for PowerLink Interface Modules */
{
    ...
    USINT slot;         /* slot of the POWERLINK interface card */
    USINT subslot;      /* subslot of the POWERLINK interface card */
    USINT interface;    /* interface number */
    ...
    SINT  ATOCtaskclass;/* taskclass triggering the Output-DMA, 0 ..triggered by System-Tick, plCE_CYCLIC_1 to plCE_CYCLIC_8 ..triggered by cyclic taskklass */
    UDINT reservedlong; /* reserved set to 0 */
}PLSYSCONF_IF_typ;

typedef struct PLSYSCONF_typ /* global PowerLink configuration */
{
    USINT noIF;         /* number of interface cards (allways 1 on SG3) */
    USINT takt_master;  /* Which interface is taktmaster on SG3 (allways 1), 0 for no taktmaster */
...
_BUR_PUBLIC UINT plConfig(PLSYSCONF_typ *pConfigStruct);
_BUR_PUBLIC UINT plCECreate(const char* pDatapoint, void* address, SINT taskclass, UDINT *pIdent);
_BUR_PUBLIC UINT plCEDelete(UDINT ident);
_BUR_PUBLIC UINT plState(UDINT ident);
_BUR_PUBLIC UINT plAction(UDINT ident, UDINT actionID, void* pObject, UDINT objectSize);
_BUR_PUBLIC UINT plAcycOpen(const char* pName, UDINT flags, UDINT *pIdent);
_BUR_PUBLIC UINT plAcycClose(UDINT ident);
_BUR_PUBLIC UINT plAcycRead(UDINT ident, void* bufferAdr, UDINT bufferLen, UDINT *pReadLen);
_BUR_PUBLIC UINT plAcycInvite(UDINT ident);
_BUR_PUBLIC UINT plAcycWrite(UDINT ident, void* bufferAdr, UDINT bufferLen, UDINT *pWrittenLen);
